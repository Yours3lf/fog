...
int main( int argc, char** argv )
{
  ...
  frm.load_shader( lighting_shader, GL_VERTEX_SHADER, "../shaders/fog/lighting.vs" );
  frm.load_shader( lighting_shader, GL_FRAGMENT_SHADER, "../shaders/fog/lighting.ps" );

  GLuint gbuffer_shader = 0;
  frm.load_shader( gbuffer_shader, GL_VERTEX_SHADER, "../shaders/fog/gbuffer.vs" );
  frm.load_shader( gbuffer_shader, GL_FRAGMENT_SHADER, "../shaders/fog/gbuffer.ps" );
  ...
  GLint lighting_ws_cam_pos_loc = glGetUniformLocation( lighting_shader, "ws_cam_pos" );
  GLint lighting_inv_mv_loc = glGetUniformLocation( lighting_shader, "inv_mv" );
  ...
  frm.display( [&]
  {
    ...
    glUniformMatrix4fv( lighting_inv_mv_loc, 1, false, &inv_mv[0][0] );
    vec3 ws_cam_pos = vec3(0);
    glUniform3fv( lighting_ws_cam_pos_loc, 1, &ws_cam_pos[0] );
